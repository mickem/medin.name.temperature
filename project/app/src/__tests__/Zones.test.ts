...
import { FakeManager, makeDevice, makeDeviceEx, makeZones } from "../TestHelpers";
...
test('reset maxmin should reset max and min', async () => {
  ...
  expect(z.getMin()).toEqual(3.4);
  expect(z.getMax()).toEqual(23.4);
  zones.resetMaxMin();
  expect(z.getMin()).toBeUndefined();
  expect(z.getMax()).toBeUndefined();
  await t2.update(45);
  expect(z.getMin()).toEqual(45);
  expect(z.getMax()).toEqual(45);
  await t2.update(22);
  expect(z.getMin()).toEqual(22);
  expect(z.getMax()).toEqual(45);
  await t3.update(-2);
  expect(z.getMin()).toEqual(-2);
  expect(z.getMax()).toEqual(45);
  await t1.update(99);
  expect(z.getMin()).toEqual(-2);
  expect(z.getMax()).toEqual(99);
  zones.resetMaxMin();
  expect(z.getMin()).toBeUndefined();
  expect(z.getMax()).toBeUndefined();
})
